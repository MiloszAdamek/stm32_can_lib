...
volatile uint16_t g_heartbeat_period_ms = 1000; // Default 1 Hz
volatile uint16_t g_telemetry_period_ms = 100;  // Default 10 Hz
...
void CAN_Slave_Telemetry(void)
{
    ...
    MotorControl_GetCANTelemetry(&current_angle_rev, &current_velocity_rpm);
